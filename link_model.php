...
<form action="/link_python.php" method='Post'>
    ...
    <!--<input name="Company[]" type="checkbox" value="Amazon" /></span><span style="color:#000000;">Amazon</span><span style="color:#000000;"> &nbsp;&nbsp; -->
    <!--<input name="Company[]" type="checkbox" value="Microsoft" /></span><span style="color:#000000;">Microsoft</span><span style="color:#000000;"> &nbsp;&nbsp; </span></p >-->
