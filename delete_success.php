...
<h1 id="hdrDescription">UserInfo Deleted Successful!</h1>
<p></p>
...
<form action="/show_profile.php" method='Post'>
    <p><span style="color:#ff9999;"><span style="font-size:16px;">TO CHECK IF DELETED, PLEASE ENTER YOUR USERNAME</span></span></p >
