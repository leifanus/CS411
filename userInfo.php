...
$Major = $School = $GPA = $userName = "";
$Major_err = $School_err = $GPA_err = $userName_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($userName_err) && empty($Major_err) && empty($School_err) && empty($GPA_err)){
...
<h1 id="hdrDescription">Tell Us About Yourself</h1>
