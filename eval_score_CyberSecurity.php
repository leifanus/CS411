...
if(empty($userName_err)) {
    ...
    $skillCONCJ = $_POST['SkillCONCJ'];
    $skillCPIDT = $_POST['SkillCPIDT'];
    
    $internProject = $_POST['InternProject'];
    $internProjectOth = $_POST['InternProjectOth'];
    
    $courseISCDI = $_POST['CourseISCDI'];
    $courseE = $_POST['CourseE'];
    
    $jobType = "CyberSecurity";
    $skillScore = sizeof($skillCONCJ) * 16.00 + sizeof($skillCPIDT) * 6.00;
    $courseScore = sizeof($courseISCDI) * 15.00 + sizeof($courseE) * 10.00;
    ...
    $CyberSecurityScore = $skillScore * 0.3 + $internProjectScore * 0.35 + $majorScore * 0.15 + $gpaScore * 0.1 + $schoolScore * 0.05 + $courseScore * 0.05;
    // echo("skill = ");
    // echo($skillScore);
    // echo(" intern = ");
    ...
    if (mysqli_num_rows($result3)) {
        $sqlUpdate = "UPDATE Score SET skillScore = '$skillScore', courseScore = '$courseScore', internProjectScore = '$internProjectScore', majorScore = '$majorScore', gpaScore = '$gpaScore', schoolScore = '$schoolScore', totalScore = '$CyberSecurityScore' WHERE userName = '$userName' AND jobType = '$jobType'";
        if ($stmt = mysqli_prepare($mysqli, $sqlUpdate)) {
            ...
            $param_gpa = $gpaScore; 
            $param_total = $CyberSecurityScore;
            ...
            $comb = array("jobType" => (string)$jobType,  
              ...
              "CyberSecurityScore" => (string)$CyberSecurityScore
              );
        ...
        // Bind variables to the prepared statement as parameters
            ...
            $param_totalScore = $CyberSecurityScore;
